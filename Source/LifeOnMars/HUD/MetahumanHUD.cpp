...
#include "MetahumanHUD.h"
#include "GameFramework/PlayerController.h"
#include "CharacterOverlay.h"

 void AMetahumanHUD::BeginPlay() 
{
	Super::BeginPlay();
	AddCharacterOverlay();
}
 void AMetahumanHUD::AddCharacterOverlay()
{
...
//DrawCrosshair
//Branch1
void AMetahumanHUD::DrawCrosshair(UTexture2D* Texture, FVector2D ViewportCenter,FVector2D Spread, FLinearColor CrosshairColor)
{
